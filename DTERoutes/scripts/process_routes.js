...
async function processRoute(geojsonPath) {
  ...
  console.log(
    `  ⏱️  Estimated duration: ${feature.properties.estimated_duration_mins} mins`,
  );
  ...
  console.log(
    `     Coordinates: ${fullRoute.geometry.coordinates.length} points`,
  );
  console.log(
    `     Turn instructions: ${fullRoute.legs.reduce(
